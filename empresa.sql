...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Jun-2023 às 03:58
...
--
-- Estrutura da tabela `funcionarios_possui_manual`
--
...
--
-- Extraindo dados da tabela `funcionarios_possui_manual`
--
...
--
-- Estrutura da tabela `manual_possui_topico`
--
...
--
-- Extraindo dados da tabela `manual_possui_topico`
--
...
--
-- Índices para tabela `funcionarios_possui_manual`
--
...
--
-- Índices para tabela `manual_possui_topico`
--
...
--
-- Limitadores para a tabela `funcionarios_possui_manual`
--
ALTER TABLE `funcionarios_possui_manual`
...
--
-- Limitadores para a tabela `manual_possui_topico`
--
ALTER TABLE `manual_possui_topico`
